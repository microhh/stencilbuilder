...
printStencil(uw_diss, rhs_diss_x1, "-=", "int", "_x1")
printEmptyLine(1)
printStencil(uw_diss, rhs_diss_y1, "-=", "int", "_y1")
printEmptyLine(1)
printStencil(uw_diss, rhs_diss_z1, "-=", "int", "_z1")
printEmptyLine(1)
printStencil(uw_diss, rhs_diss_x2, "-=", "int", "_x2")
printEmptyLine(1)
printStencil(uw_diss, rhs_diss_y2, "-=", "int", "_y2")
printEmptyLine(1)
printStencil(uw_diss, rhs_diss_z2, "-=", "int", "_z2")
